...
import com.yang.service.demo.WelcomeService;

/**
 * Servlet implementation class WelcomeServlet
 */
@WebServlet("/WelcomeServletNew") //Declare a Servlet
...
//		//1. Create the data(model) and add to request obj
		//Invoking bussiness layer
		WelcomeService welcomeService = new WelcomeService();
		List<String> welcomeMessage = welcomeService.getWelcomeMessage("Shaco");
